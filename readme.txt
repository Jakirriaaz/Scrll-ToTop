...
Scroll to top. It is very usefull smale plugin. nice design and simple.

== Description ==

Easy to use. Scroll to top. It is very usefull smale plugin. nice design and simple. Anyone can use it for better experiece as well. 
...
= A question that someone might have = How to install? 

Just search scrolltotop plugin in the wp.org and easy to donwload and install. 
